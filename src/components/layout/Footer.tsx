  ...
  return (
    <footer className="w-full bg-secondary">
              ...
              <ul className="space-y-3">
                ...
                <li className="flex items-center justify-center sm:justify-start gap-4 pt-2">
                    <Link href="https://www.facebook.com/dungeonpub/" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
                        <Facebook className="h-6 w-6 text-muted-foreground transition-all duration-200 hover:text-primary hover:scale-110" />
                    </Link>
                    <Link href="https://www.instagram.com/dungeon_pub" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
                        <Instagram className="h-6 w-6 text-muted-foreground transition-all duration-200 hover:text-primary hover:scale-110" />
                    </Link>
                </li>
              </ul>
            </div>
      ...
      {isVisible && (
            <Button
                onClick={scrollToTop}
                className="fixed bottom-8 right-8 h-14 w-14 rounded-full shadow-lg transition-all duration-300 hover:scale-110 active:scale-100"
                variant="default"
                size="icon"
